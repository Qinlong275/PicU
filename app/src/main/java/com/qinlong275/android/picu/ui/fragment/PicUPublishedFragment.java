...
import com.qinlong275.android.picu.presenter.PublishedPresenter;
...
public class PicUPublishedFragment extends ProgressFragment<PublishedPresenter> implements PicUContract.PublishedView {
    ...
    void onEmptyViewClick() {
        mPresenter.getPublishedPicu();
    }

    @Override
    public void init() {
        initRecyclerView();
        mPresenter = new PublishedPresenter(new PublishedModel(), this);
        mPresenter.getPublishedPicu();
    }
    ...
    private void initRecyclerView(){
        ...
        mPicUlistAdapter=new PicUlistAdapter(2,getActivity(),mPicUItems);
...
//        mPicUlistAdapter.setDate(null);
    ...
    private void initPiuList( List<PicUItem> picUItems){
        picUItems.add(new PicUItem("q","","a","","a","","","2","true"));
        picUItems.add(new PicUItem("","","a","","0","","","3",""));
        picUItems.add(new PicUItem("q","","a","","a","","","2",""));
        picUItems.add(new PicUItem("","","a","","0","","","","true"));
